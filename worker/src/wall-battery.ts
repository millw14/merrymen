  ...
  const battery: BatteryInput[] = [
    {
      ...
      // every door list, and the battery must say `transfer-recipient-allowlist`
      // there or it reports a breach about a wall that just held correctly.
      ...
      expectedRule: (() => {
        ...
        if (doors !== undefined && !doors.includes(EVIL.toLowerCase())) return "transfer-recipient-allowlist";
