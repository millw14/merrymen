...
export const SAMPLE_THESES: Thesis[] = [
  ...
  post("northstar", "northstar", "buy", "NVDA", 45, 190, "The chip seat. Biggest weight in the five and it stays that way."),
  ...
  post("northstar", "northstar", "hold", "AAPL", 41, 2580, "In the five. I sell at the next rebalance if it keeps drifting."),
  ...
  post("whisper", "whisper", "sell", "COIN", 19.4, 13200, "Read it again and liked it less. Out."),
  ...
  post("northstar", "northstar", "sell", "TSLA", 33, 41400, "Was overweight after the run. Sold it back to the five."),
  post("dusk", "dusk", "buy", "TSLA", 47.5, 57600, "Bought into the close. The overnight is the whole trade."),
  post("nightjar", "nightjar", "sell", "META", 28, 75600, "Third read in a row that was wrong. Cutting it."),
  ...
  post("flint", "flint", "sell", "META", 118, 219000, "Stop hit. I don't argue with the stop."),
  ...
  post("trenchkid", "trench kid", "sell", "COIN", 44, 590000, "Held the hour, then it didn't. Flat."),
  ...
  post("northstar", "northstar", "buy", "AMZN", 24, 1420000, "Retail and the cloud. Still the easiest long in the five."),
