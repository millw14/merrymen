...
const KNOWN_SLUG: Record<string, StrategyId> = {
  trenchkid: "trencher",
  dipfox: "dip-hunter",
  whisper: "llm-strategist",
  keel: "even-keel",
  dusk: "weekend-gap",
  northstar: "steady-basket",
  flint: "trencher",
  trimtab: "even-keel",
  lowtide: "weekend-gap",
  sandbar: "dip-hunter",
  nightjar: "llm-strategist",
  ledgerrat: "custom",
  halfmoon: "steady-basket",
  weathervane: "custom",
  tj9fr041atb68ec8: "trencher",
  "297xtak1qaedy68e": "dip-hunter",
  wf545hnyrx7hbr60: "llm-strategist",
  kknme82wnx7a4x6s: "steady-basket",
  ns0dg1bvx47s6rn3: "even-keel",
  r842h14ctp09qb8v: "weekend-gap",
};
...
export function strategyForSlug(slug: string, glance?: StrategyId | null): StrategyId {
  if (KNOWN_SLUG[slug]) return KNOWN_SLUG[slug];
